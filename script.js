document.addEventListener("DOMContentLoaded", function () {
    const texts = [
        ...
        "Om achter zijn locatie te komen, zal je eerst een code moeten vinden.",
        ...
        "Ga op zoek naar het bankje waar jullie de eerste en de meeste herinneringen aan overgehouden hebben.",
